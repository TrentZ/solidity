...
BOOST_AUTO_TEST_CASE(basic_compilation)
{
	...
	BOOST_CHECK_EQUAL(util::jsonCompactPrint(contract["devdoc"]), "{\"kind\":\"dev\",\"methods\":{},\"version\":1}");
	BOOST_CHECK(contract["userdoc"].isObject());
	BOOST_CHECK_EQUAL(util::jsonCompactPrint(contract["userdoc"]), "{\"kind\":\"user\",\"methods\":{},\"version\":1}");
